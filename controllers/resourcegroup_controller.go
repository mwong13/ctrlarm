...
// +kubebuilder:rbac:groups=azure.jpang.dev,resources=resourcegroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=azure.jpang.dev,resources=resourcegroups/status,verbs=get;update;patch
